...
public class TestedModel {
    ...
    public String toString() {
        return "ClassPojo [testsperconfirmedcase = " + testsperconfirmedcase + ", individualstestedperconfirmedcase = " + individualstestedperconfirmedcase + ", testpositivityrate = " + testpositivityrate + ", testsconductedbyprivatelabs = " + testsconductedbyprivatelabs + ", totalsamplestested = " + totalsamplestested + ", positivecasesfromsamplesreported = " + positivecasesfromsamplesreported + ", samplereportedtoday = " + samplereportedtoday + ", source = " + source + ", updatetimestamp = " + updatetimestamp + ", totalindividualstested = " + totalindividualstested + ", totalpositivecases = " + totalpositivecases + "]";
    }
}
